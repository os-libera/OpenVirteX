 ...
 * begins with a integral value to indicate the format of the remaining data. It
 * maps from the per-vendor-id integral data type code to the object used to
 * instantiate the class associated with that vendor data type.
 *
...
public class OFBasicVendorDataType extends OFVendorDataType {
     ...
     *
     * @param type
     *            Wire protocol number associated with this vendor data type
     * @param instantiator
