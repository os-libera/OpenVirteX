 ...
 * message. Typically the vendor data will begin with an integer code that
 * determines the format of the rest of the data, but this class does not assume
 * that. It's basically just a holder for an instantiator of the appropriate
...
public class OFVendorDataType {
    ...
    /**
     * Returns a new instance of a subclass of OFVendorData associated with this
     * OFVendorDataType.
     *
