 ...
 * vendor. It is responsible for knowing how to parse out some sort of data type
 * value from the vendor data in an OFVendor message so that we can dispatch to
 * the different subclasses of OFVendorData corresponding to the different
 * formats of data for the vendor extensions.
 *
