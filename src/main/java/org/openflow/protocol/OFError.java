...
public class OFError extends OFMessage implements OFMessageFactoryAware {
    ...
    public enum OFErrorType {
        // OFPET_VENDOR_ERROR is an extension that was added in Open vSwitch and
        // isn't
        // in the OF 1.0 spec, but it was easier to add it here instead of
        // adding
        // generic support for extensible vendor-defined error messages.
        // It uses the random value 0xb0c2 to avoid conflicts with other
        // possible new
        // error types. Support for vendor-defined extended errors has been
        // standardized
