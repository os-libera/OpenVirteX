...
public class OFNiciraVendorExtensions {
    ...
    public static synchronized void initialize() {
        if (OFNiciraVendorExtensions.initialized) {
            return;
        }

        // Configure openflowj to be able to parse the role request/reply
        // vendor messages.
        final OFBasicVendorId niciraVendorId = new OFBasicVendorId(
                OFNiciraVendorData.NX_VENDOR_ID, 4);
        OFVendorId.registerVendorId(niciraVendorId);
        final OFBasicVendorDataType roleRequestVendorData = new OFBasicVendorDataType(
        ...
        final OFBasicVendorDataType roleReplyVendorData = new OFBasicVendorDataType(
        ...
        OFNiciraVendorExtensions.initialized = true;
    }
}
