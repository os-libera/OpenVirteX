...
public class OFRoleVendorData extends OFNiciraVendorData {
    ...
    /**
     * Construct an OFRoleVendorData with the specified data type (i.e. either
     * request or reply) and an unspecified role.
     *
     * @param dataType
     */
    ...
    /**
     * Construct an OFRoleVendorData with the specified data type (i.e. either
     * request or reply) and role (i.e. one of of master, slave, or other).
     *
     * @param dataType
