    ...
    public JSONRPC2Response process(final Map<String, Object> params) {
        try {
            final Number dpid = HandlerUtils.<Number>fetchField(
                    MonitoringHandler.DPID, params, true, -1);
            PhysicalSwitch psw = PhysicalNetwork.getInstance().getSwitch(dpid.longValue());
            
            return new JSONRPC2Response(new LinkedList<Short>(psw.getPorts().keySet()), 0);
