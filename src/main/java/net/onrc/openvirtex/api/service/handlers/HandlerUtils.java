...
public final class HandlerUtils {
     ...
     * any of the other ones, throw an exception.
     *
    ...
    public static void isValidDPID(final int tenantId, final List<Long> dpids)
        ...
        for (final long dpid : dpids) {
            ...
            try {
                ...
                throw new InvalidDPIDException("Virtual switch " + String.valueOf(dpid) +
                        " is unknown.");
            }

            // Are all dpids connected - only relevant when creating a
            // bigswitch?
            if (dpids.size() > 1) {
