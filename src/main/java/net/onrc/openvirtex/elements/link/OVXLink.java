            ...
            public boolean tryRevert(OVXLink vlink, PhysicalLink plink) {
                try {
                    if (vlink.unusableLinks.isEmpty()) {
                        if(!vlink.map.getPhysicalLinks(vlink).contains(plink)){
                            return false;
                        }
                    }
