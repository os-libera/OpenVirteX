...
public class LLDPUtil {
	...
	/**
	 * Is this an LLDP packet generated by OVX?
	 * 
	 * @param packetArray
	 * @return True if packet is LLDP, False otherwise
	 */
	public static boolean checkOVXLLDP(final byte[] packetArray) {
		if ((LLDPUtil.checkLLDP(packetArray)) && (packetArray.length >= (LLDPUtil.OFFSET_OVX_NAME + LLDPUtil.OVX_NAME.length()))) {			
