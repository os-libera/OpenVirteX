        ...
        try {
            if (inPort.isEdge()) {
              ...
              //max number of bits required to represent TenantId
                 ...
                 * rewrite it to (16.x.x.x/4). Same if source is wildcard.
                 * Where 16.0.0.0/4 is the network address for destination for 
                 * tenant 1.
                 */
                if(this.match.getWildcardObj().isWildcarded(Flag.NW_SRC)){
                    try {
                        ...
                        //partial wildcard destinatoin i.e adding Subnet
